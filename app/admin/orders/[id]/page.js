...
const handleStatusUpdate = async () => {
  if (!newStatus) return; // prevent sending empty

  const normalizedStatus = newStatus.trim().toLowerCase(); // make sure matches backend
  ...
  const statusHistory = order.status_history || []; // expect backend to return array of {old_status, new_status, changed_at}
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white shadow rounded-lg p-6 space-y-4">
        ...
        <div className="space-y-2">
          ...
          {/* Admin dropdown for allowed transitions */}
